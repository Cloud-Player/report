...
% BEGINN: Optionen für typearea
               ...
               DIV=10,   % je höher der DIV-Wert, desto mehr geht auf eine Seite. Gute werde sind zwischen DIV=12 und DIV=15
               headinclude=true,
               footinclude=false,
...
\input{content/3-implementation/0-index.tex}
\input{content/4-analysis/0-index.tex}
\input{content/5-resume/0-index.tex}
%
%
