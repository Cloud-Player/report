...
\begin{itemize}
    ...
    \itembf{Analysis-Tools} To analyse the implementation and for debugging during the development, several tools have been implemented. This chapter introduces the simulation tool, the visualisation tool and the \gls{cli} which has been used for benchmarking.
